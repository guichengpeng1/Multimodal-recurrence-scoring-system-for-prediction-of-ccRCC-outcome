...
setwd("//Volumes//2022DB-GCP//AI//multimodal//figures and tables//TRAIN")
TCGA.risk.score <- read.csv("//Volumes//2022DB-GCP//AI//multimodal//figures and tables//TRAIN//train7-7.csv")
#risk score
